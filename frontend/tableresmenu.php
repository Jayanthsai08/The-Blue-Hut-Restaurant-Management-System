        ...
        <div class="container-xxl position-relative p-0">
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    ?>
                    <a href="tableresorders.php" class="btn btn-primary py-2 px-4"><i class="fas fa-shopping-cart"></i><span> Order items <?php echo $count; ?></span></a>
                </div>
            </nav>
                        ...
                        <div class="col-lg-3">
                            <div class="card">
                                ...
                                <div class="card-body text-center">
                                    <form action="newtableorder.php" method="POST">
                                    <h5 class="card-title"><?php echo $title; ?></h5>
                                    <p class="card-text"><?php echo $price; ?></p>
                                    <button type="submit" name="Add_To_Cart" class="btn btn-primary btn-sm">Add item</button>
                ...
                <div class="copyright">
                    <div class="row">
                        <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                            &copy; <a class="border-bottom" href="#">Paradise Cafe</a>, All Right Reserved. 
