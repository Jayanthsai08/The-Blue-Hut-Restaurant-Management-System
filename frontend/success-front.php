...
<div class="container">
  ...
  <div class="brand-title">Blue Hut Cafe</div>
  ...
  <?php 
    ...
    if($res == true)
    { 
      $_SESSION['success'] = "Hello, " .$cus_name. ". Your Payment of INR " .$amount. " is Successful."."<br/> Transaction ID: ".$tran_id. ". Time of Payment: ".$pay_time;
      header('location:'.SITEURL.'payment-redir-front.php');
    }
    else
    {
      $_SESSION['fail'] = "Your Payment of INR " .$amount. " is Not Successful."."<br/> Transaction ID: ".$tran_id ."Please Try Again";
