...
<body>
        ...
        <div class="container position-relative p-0">
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <a href="<?php echo SITEURL; ?>cart.php" class="btn btn-primary py-2 px-4"><i class="fas fa-shopping-cart"></i><span>Orders</span></a>
                </div>
            </nav>
 ...
 <div class="card" style="max-width: 500px;">
  <div class="row no-gutters justify-content-center">
    ...
    <div class="col-md-12">
      <div class="card-body">
        <h5 class="card-title text-center">Item Added to Order!</h5>
        <a href="<?php echo SITEURL; ?>tablemenu.php" class="btn btn-primary btn-lg btn-block">Continue</a>
        <a href="<?php echo SITEURL; ?>cart.php" class="btn btn-primary btn-lg btn-block"><i class="fas fa-shopping-cart"></i><span> View orders</span></a>
