            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-6">
                        ...
                        <p class="mb-4">Blue Hut Cafe began its journey from 2017 and has been one of the prominent restaurants in town ever since.Originally serving fast food in Dhaka,
                            We only use the top-quality ingredients to prepare the dishes for our valued customers.Quality is never compromised.</p>
