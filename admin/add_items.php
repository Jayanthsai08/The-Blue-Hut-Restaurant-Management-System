...
<body>
                ...
                <div class="container text-center my-5 pt-5 pb-4">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center text-uppercase">
                            ...
                            <li class="breadcrumb-item text-white active" aria-current="page">Order Items</li>
                        </ol>
                    </nav>
                </div>
            </div>
 ...
 <div class="card" style="max-width: 500px;">
  <div class="row no-gutters justify-content-center">
    ...
    <div class="col-md-12">
      <div class="card-body">
        <h5 class="card-title text-center">Item Added!</h5>
        <a href="<?php echo SITEURL; ?>menu.php" class="btn btn-primary btn-lg btn-block">Continue</a>
        <a href="<?php echo SITEURL; ?>cart.php" class="btn btn-primary btn-lg btn-block"><i class="fas fa-shopping-cart"></i><span> View Order</span></a>
