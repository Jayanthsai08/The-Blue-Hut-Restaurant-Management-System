...
$sql = "SELECT * FROM reservations ORDER BY res_id DESC";
...
$sn = 1; //Create a Serial Number and set its initail value as 1
                            ...
                            while($row=mysqli_fetch_assoc($res))
                            {
                                ...
                                ?>
                                    ...
                                    <tr>
										...
										<td>
											<a href="<?php echo SITEURL; ?>delete-reservation.php?id=<?php echo $res_id; ?>" class="button-7" role="button" >Free</a>	
							             </td>   
                                    </tr>
                        ...
                        {
                            //Order not Available
                            echo "<tr><td colspan='7' class='error'>resrvation not Available</td></tr>";
                        }
?>
