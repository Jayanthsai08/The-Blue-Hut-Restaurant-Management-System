...
<br>
		...
		<tr>
                <td>ID</td>
                <td>
                    <input type="text" name="id" value="<?php echo $id; ?>" id="ip2">
                </td>
            </tr>
            <tr>
                <td>Customer Name</td>
                <td>
                    <input type="text" name="cust_name" value="<?php echo $cust_name; ?>" id="ip2">
                </td>
            </tr>
            <tr>
                <td>Table number</td>
                <td>
                    <input type="text" name="tbl_no" value="<?php echo $tbl_no; ?>" id="ip2">
                </td>
            </tr>
            <tr>
                <td>Order Date</td>
                <td>
                    <input type="text" name="ord_date" value="<?php echo $ord_date; ?>" id="ip2">
                </td>
            </tr>
            <tr>
                <td>Phone Number</td>
                <td>
                    <input type="text" name="phno" value="<?php echo $phno; ?>" id="ip2">
                </td>
            </tr>
            ...
            <tr>
                <td>Total Amount</td>
                <td>
                    <input type="text" name="total" value="<?php echo $total_amount; ?>" id="ip2">
                </td>
            </tr>
			<tr>
                <td>Order Status</td>
